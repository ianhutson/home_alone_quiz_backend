q1 = Question.create(text: "Why doesn’t Kevin want to sleep with Fuller on the third floor?", difficulty: "easy", pic: "images/18.png")
a1 = Answer.create([
...
q2 = Question.create(text: "What street do the McCallisters live on?", difficulty: "hard", pic: "images/2.png")
a2 = Answer.create([
...
q3 = Question.create(text: "In Home Alone 2, upon arriving at Kevin's aunt and uncle's house, Kevin unveils the schematics for operation _____", difficulty: "hard", pic: "images/30.png")
a3 = Answer.create([
...
q4 = Question.create(text: "Buzz has a pet _____", difficulty: "easy", pic: "images/9.png")
a4 = Answer.create([
...
q5 = Question.create(text: "What did Buzz tell Kevin to pack in Home Alone?", difficulty: "medium", pic: "images/5.png")
...
q6 = Question.create(text: "In Home Alone, what is the old man with the shovel's villain name?", difficulty: "medium", pic: "images/11.png")
...
q7 = Question.create(text: "What year did the shovel man allegedly murder his whole family and half the block?", difficulty: "hard", pic: "images/10.png")
...
q8 = Question.create(text: "Little Nero's delivers, ___ minutes or less, or your pizza's free!", difficulty: "hard", pic: "images/13.png")
...
q9 = Question.create(text: "What are the burglar's nicknames in Home Alone?", difficulty: "easy", pic: "images/26.png")
...
q10 = Question.create(text: "What are the burglar's nicknames in Home Alone 2?", difficulty: "easy", pic: "images/44.png")
...
q11 = Question.create(text: "Where does Kevin first speak with old man Marley?", difficulty: "easy", pic: "images/32.png")
...
q12 = Question.create(text: "In Home Alone, the burglars ride around in a van with what decal?", difficulty: "hard", pic: "images/26.png")
...
q13 = Question.create(text: "Where is the polka band heading with their van from the airport?", difficulty: "easy", pic: "images/31.png")
...
q14 = Question.create(text: "What are the names of the burglars?", difficulty: "easy", pic: "images/56.png")
...
q15 = Question.create(text: "What is the name of the main character's father?", difficulty: "easy", pic: "images/14.png")
...
q16 = Question.create(text: "What airlines does the family fly in Home Alone?", difficulty: "hard", pic: "images/23.png")
...
q17 = Question.create(text: "Who flies first class in Home Alone?", difficulty: "hard", pic: "images/23.png")
...
q18 = Question.create(text: "What is Kevin afraid of in the basement?", difficulty: "easy", pic: "images/24.png")
...
q19 = Question.create(text: "What is the title of the black and white movie Kevin watches in both movies?", difficulty: "hard", pic: "images/25.png")
...
q20 = Question.create(text: "What brand of toy cars are used for a trap in the first movie?", difficulty: "medium", pic: "images/33.png")
...
q21 = Question.create(text: "What celebrity directs Kevin to the lobby inside the Plaza Hotel?", difficulty: "easy", pic: "images/48.png")
...
q22 = Question.create(text: "What is the name of the school that hosts the pageant in Home Alone 2?", difficulty: "hard", pic: "images/40.png")
...
q23 = Question.create(text: "What what Kevin rather do than apologize to Buzz?", difficulty: "medium", pic: "images/38.png")
...
q24 = Question.create(text: "What house decor do drivers commonly hit in front of the McCallister home?", difficulty: "easy", pic: "images/22.png")
...
q25 = Question.create(text: "What's Kevin's problem with Florida?", difficulty: "medium", pic: "images/35.png")
...
q26 = Question.create(text: "In Home Alone 2, what event causes Peter to accidentally unplug the alarm, causing the family to sleep in?", difficulty: "hard", pic: "images/36.png")
...
q27 = Question.create(text: "What Christmas event does Kevin shove Buzz, starting family drama?", difficulty: "easy", pic: "images/39.png")
...
q28 = Question.create(text: "What city does Kevin accidentally fly to in Home Alone 2?", difficulty: "easy", pic: "images/43.png")
...
q29 = Question.create(text: "Kevin's Aunt and Uncle's name in New York city?", difficulty: "hard", pic: "images/58.png")
...
q30 = Question.create(text: "What smell does Harry accuse Marv of confusing for fish in the NYC fish market?", difficulty: "medium", pic: "images/44.png")
...
q31 = Question.create(text: "What is Cedric's, the bellhop in Home Alone 2, actor's name?", difficulty: "medium", pic: "images/50.png")
...
q32 = Question.create(text: "What technique does Kevin practice at the hotel pool?", difficulty: "medium", pic: "images/51.png")
...
q33 = Question.create(text: "What is Kevin's favorite flavor of pizza?", difficulty: "medium", pic: "images/29.png")
...
q34 = Question.create(text: "Who has the gimpy leg in the black and white movie?", difficulty: "hard", pic: "images/25.png")
...
q35 = Question.create(text: "What Christmas ornament does Kevin give pigeon lady Home Alone 2?", difficulty: "easy", pic: "images/54.png")
...
q36 = Question.create(text: "Who stayed on Kevin's Plaza Hotel floor?", difficulty: "hard", pic: "images/46.png")
...
q37 = Question.create(text: "How many scoops of ice cream does Kevin request from room service Home Alone 2?", difficulty: "medium", pic: "images/48.png")
...
q38 = Question.create(text: "What is the toy store's name in Home Alone 2?", difficulty: "easy", pic: "images/55.png")
...
q39 = Question.create(text: "What does Buzz’s pet eat?", difficulty: "hard", pic: "images/8.png")
...
q40 = Question.create(text: "How much is the pizza delivery in Home Alone?", difficulty: "hard", pic: "images/13.png")
